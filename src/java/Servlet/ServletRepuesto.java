...
public class ServletRepuesto extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            int idRepuesto = 0;
            if (request.getParameter("txtidpersona") != null) {
                idRepuesto = Integer.parseInt(request.getParameter("txtidpersona"));
            }

            Repuesto datos = new Repuesto();
            List<RepuestoModel> lista = new ArrayList<>();
            if (idRepuesto == 0) {
                lista = datos.Consultar();
            }
